...
- **A Survey on Vision-Language-Action Models for Embodied AI** `VLA` `Survey`  
  *Yueen Ma, Zixing Song, Yuzheng Zhuang, et al.*  
  TNNLS 2026, 2024.05  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2405.14093)

- **Large Multimodal Agents: A Survey** `Survey` `MLLM`  
  *Junlin Xie, Zhihong Chen, Ruifei Zhang, et al.*  
  Visual Intelligence 2025, 2024.02  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2402.15116) [![Code](https://img.shields.io/badge/-Code-181717?logo=github&logoColor=white&style=flat-square)](https://github.com/jun0wanan/awesome-large-multimodal-agents)
...
- **Integrated Task and Motion Planning** `Plan` `Survey` `Planning`  
  *Caelan Reed Garrett, Rohan Chitnis, Rachel Holladay, et al.*  
  ...
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2010.01083)
...
- **Enhancing Rating-Based Reinforcement Learning to Effectively Leverage Feedback from Large Vision-Language Models** `Verify` `MLLM` `RL`  
  *Tung Minh Luu, Younghwan Lee, Donghoon Lee, et al.*  
  ICML 2025, 2025.06  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2506.12822)
...
- **Hi Robot: Open-Ended Instruction Following with Hierarchical Vision-Language-Action Models**  
  *Lucy Xiaoyang Shi, Brian Ichter, Michael Equi, et al.*  
  ICML 2025, 2025.02  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2502.19417) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://www.physicalintelligence.company/research/hirobot)
...
- **UP-VLA: A Unified Understanding and Prediction Model for Embodied Agent** `Anticipate` `VLA` `World Model`  
  *Jianke Zhang, Yanjiang Guo, Yucheng Hu, et al.*  
  ICML 2025, 2025.01  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2501.18867)
...
- **SpatialVLM: Endowing Vision-Language Models with Spatial Reasoning Capabilities** `Perceive` `MLLM` `Memory`  
  ...
  *Boyuan Chen, Zhuo Xu, Sean Kirmani, et al.*  
  CVPR 2024, 2024.01  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2401.12168) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://spatial-vlm.github.io/)
...
- **Learning Interactive Real-World Simulators** `Anticipate` `World Model`  
  ...
  *Sherry Yang, Yilun Du, Seyed Ghasemipour, et al.*  
  ICLR 2024, 2023.10  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2310.06114) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://universal-simulator.github.io/unisim/)
...
- **Plug in the Safety Chip: Enforcing Constraints for LLM-driven Robot Agents** `Plan`  
  *Ziyi Yang, Shreyas Sundara Raman, Ankit Shah, et al.*  
  ICRA 2024, 2023.09  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2309.09919)
...
- **DoReMi: Grounding Language Model by Detecting and Recovering from Plan-Execution Misalignment** `Plan` `Verify` `Planning`  
  *Yanjiang Guo, Yen-Jen Wang, Lihan Zha, et al.*  
  IROS 2024, 2023.07  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2307.00329) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://sites.google.com/view/doremi-paper)
...
- **Vision-Language Models as Success Detectors** `Verify` `MLLM`  
  ...
  *Yuqing Du, Ksenia Konyushkova, Misha Denil, et al.*  
  arXiv, 2023.03  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2303.07280)
...
- **PaLM-E: An Embodied Multimodal Language Model** `Perceive` `Plan` `MLLM`  
  ...
  *Danny Driess, Fei Xia, Mehdi S. M. Sajjadi, et al.*  
  ICML 2023, 2023.03  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2303.03378) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://palm-e.github.io/)
...
- **Learning Language-Conditioned Robot Behavior from Offline Data and Crowd-Sourced Annotation** `Verify`  
  ...
  *Suraj Nair, Eric Mitchell, Kevin Chen, et al.*  
  CoRL 2022, 2021.09  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2109.01115) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://sites.google.com/view/robotlorel)
...
- **Scaling Synthetic Task Generation for Agents via Exploration**  
  *Ram Ramrakhya, Andrew Szot, Omar Attia, et al.*  
  ICLR 2026, 2025.09  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2509.25047)
...
- **Agent-SAMA: State-Aware Mobile Assistant** `Verify` `GUI`  
  *Linqiang Guo, Wei Liu, Yi Wen Heng, et al.*  
  AAAI 2026, 2025.05  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2505.23596)
...
- **Agent S2: A Compositional Generalist-Specialist Framework for Computer Use Agents** `Plan` `GUI`  
  ...
  *Saaket Agashe, Kyle Wong, Vincent Tu, et al.*  
  COLM 2025, 2025.04  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2504.00906) [![Code](https://img.shields.io/badge/-Code-181717?logo=github&logoColor=white&style=flat-square)](https://github.com/simular-ai/Agent-S)
...
- **Webevolver: Enhancing web agent self-improvement with co-evolving world model** `Anticipate` `World Model` `GUI`  
  ...
  *Tianqing Fang, Hongming Zhang, Zhisong Zhang, et al.*  
  EMNLP 2025, 2025.04  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2504.21024)
...
- **AutoGUI: Scaling GUI Grounding with Automatic Functionality Annotations from LLMs** `Plan` `GUI`  
  *Hongxin Li, Jingfan Chen, Jingran Su, et al.*  
  ACL 2025, 2025.02  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2502.01977)
...
- **ShowUI: One Vision-Language-Action Model for GUI Visual Agent** `Act` `GUI` `VLA`  
  ...
  *Kevin Qinghong Lin, Linjie Li, Difei Gao, et al.*  
  CVPR 2025, 2024.11  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2411.17465) [![Code](https://img.shields.io/badge/-Code-181717?logo=github&logoColor=white&style=flat-square)](https://github.com/showlab/ShowUI)
...
- **Position: LLMs Can't Plan, But Can Help Planning in LLM-Modulo Frameworks** `Plan` `Planning`  
  *Subbarao Kambhampati, Karthik Valmeekam, Lin Guan, et al.*  
  ICML 2024, 2024.02  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2402.01817)
...
- **SeeClick: Harnessing GUI Grounding for Advanced Visual GUI Agents** `Perceive` `Act` `GUI`  
  *Kanzhi Cheng, Qiushi Sun, Yougang Chu, et al.*  
  ACL 2024, 2024.01  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2401.10935) [![Code](https://img.shields.io/badge/-Code-181717?logo=github&logoColor=white&style=flat-square)](https://github.com/njucckevin/SeeClick)
...
- **ControlLLM: Augment Language Models with Tools by Searching on Graphs**  
  *Zhaoyang Liu, Zeqiang Lai, Zhangwei Gao, et al.*  
  ECCV 2024, 2023.10  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2310.17796) [![Code](https://img.shields.io/badge/-Code-181717?logo=github&logoColor=white&style=flat-square)](https://github.com/OpenGVLab/ControlLLM)
...
- **Unpacking Failure Modes of Generative Policies: Runtime Monitoring of Consistency and Progress** `Verify`  
  ...
  *Christopher Agia, Rohan Sinha, Jingyun Yang, et al.*  
  CoRL 2025, 2024.10  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2410.04640)
...
- **MIRAGE: Cross-Embodiment Zero-Shot Policy Transfer with Cross-Painting** `Act`  
  *Lawrence Yunliang Chen, Karthik Dharmarajan, Kush Hari, et al.*  
  RSS 2024, 2024.02  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2402.19249)
...
- **Example-Driven Model-Based Reinforcement Learning for Solving Long-Horizon Visuomotor Tasks** `Verify` `Manip.` `RL`  
  *Bohan Wu, Suraj Nair, Li Fei-Fei, et al.*  
  CoRL 2022, 2021.09  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2109.10312)
...
- **ORB-SLAM3: An Accurate Open-Source Library for Visual, Visual-Inertial and Multi-Map SLAM** `Perceive` `Memory`  
  *Carlos Campos, Richard Elvira, Juan J. Gomez Rodriguez, et al.*  
  T-RO 2021, 2020.07  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2007.11898) [![Code](https://img.shields.io/badge/-Code-181717?logo=github&logoColor=white&style=flat-square)](https://github.com/UZ-SLAMLab/ORB_SLAM3)
...
- **Composable action-conditioned predictors: Flexible off-policy learning for robot navigation** `Anticipate` `World Model` `Nav.`  
  *Gregory Kahn, Adam Villaflor, Pieter Abbeel, et al.*  
  CoRL 2018, 2018.10  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/1810.07167)
...
- **RoboChallenge: Large-scale Real-robot Evaluation of Embodied Policies** `Bench`  
  *RoboChallenge Team*  
  arXiv, 2025.10  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2510.17950) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://robochallenge.ai/home)
...
- **PLanAR: Planning-Language-Grounded Agentic Reasoning for Robot Manipulation** `Bench` `Planning`  
  *Pengyuan Guo, Zhonghao Mai, Zhengtong Xu, et al.*  
  arXiv, 2026.02  
  [![arXiv](https://img.shields.io/badge/-arXiv-B31B1B?logo=arxiv&logoColor=white&style=flat-square)](https://arxiv.org/abs/2602.01662) [![Project](https://img.shields.io/badge/-Project-4285F4?logo=googlechrome&logoColor=white&style=flat-square)](https://planar-robot.github.io/)
